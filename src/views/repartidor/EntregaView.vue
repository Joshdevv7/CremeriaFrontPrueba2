...
.check { width: 78px; height: 78px; flex: 0 0 78px; min-width: 78px; min-height: 78px; aspect-ratio: 1 / 1; flex-shrink: 0; border-radius: 50%; background: rgba(255,255,255,.14); display: grid; place-items: center; margin-bottom: 18px; position: relative; }
...
.check svg { width: 40px; height: 40px; flex-shrink: 0; stroke: #fff; fill: none; stroke-width: 3; stroke-linecap: round; stroke-linejoin: round; stroke-dasharray: 40; stroke-dashoffset: 40; animation: draw .5s ease .2s forwards; }
