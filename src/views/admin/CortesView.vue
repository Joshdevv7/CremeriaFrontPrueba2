<template>
  <div class="cortes-wrap">
    ...
    <div class="resumen-grid">
      <div class="rc-card">
        <div class="rc-lbl">Cortes listados</div>
        <div class="rc-val">{{ itemsFiltrados.length }}</div>
        <div class="rc-sub">En el filtro actual</div>
      </div>
      <div class="rc-card">
...
function setPeriodo(p) { periodo.value = p; cargar() }
