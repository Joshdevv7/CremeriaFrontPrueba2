...
var y = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-C1aScSTo-WAOR2R2E.js")).iosTransitionAnimation : (await import("./p-DIE4pXMl-RVYZ7SAE.js")).mdTransitionAnimation;
};
var h = async (n3, e) => {
  await k(e, true);
...
@ionic/core/components/p-CtukzcyX.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-FMOCS3IT.js.map
